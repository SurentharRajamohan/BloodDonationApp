                    ...
                    databaseReference.child("users").addListenerForSingleValueEvent(new ValueEventListener() {
                        ...
                        public void onDataChange(@NonNull DataSnapshot snapshot) {
                            ...
                            if(snapshot.hasChild(username)){
                                ...
                                final double latitude = snapshot.child(username).child("address").child("latitude").getValue(double.class);
                                final double longitude = snapshot.child(username).child("address").child("longitude").getValue(double.class);
